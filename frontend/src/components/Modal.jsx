...
const Modal = ({
  ...
  return (
    <div
      className={`fixed inset-0 z-50 flex items-center justify-center overflow-y-auto p-4 ${darkMode ? 'bg-black/60' : 'bg-gray-800/40'}`}  //bg-black/60 bg-opacity-50
    ...
    >
      ...
      <div
        className={`${getModalWidth()} w-full rounded-lg shadow-lg transition-all ${
          darkMode ? 'bg-gray-800/95 text-white' : 'bg-white text-gray-800'
        } relative`}
      >
        ...
        {/* Corps de la modale */}
        <div className="max-h-[calc(100vh-90px)] overflow-y-auto p-4 whitespace-nowrap scrollbar-hidden">
          {children}
        </div>
